...
namespace Keyboard
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            // If you need the system software keyboard for some entry controls put this in the 'Focused event' of the entry control:
            // 'ClassKeyboardMethods.HideBottomSheet()' and 'entry.ShowSoftInputAsync()'.
            // In the 'Unfocused event' of the entry control call 'entry.HideSoftInputAsync()'.
